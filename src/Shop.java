...
public class Shop extends Space {
    ...
    private static final Item SHARK_SKIN = new Item("Shark Skin", null, 250, 1500, 12);
    private static final Item KRAKEN_SKIN = new Item("Kraken Skin", null, 500, 5000, 13);
    private static final Item PIRATE_HAT = new Item("Pirate Hat", null, 25, 100, 14);
    private static final Item WOODEN_PEG = new Item("Wooden Peg", null, 25, 100, 16);
    private static final Item PARROT = new Item("Parrot", null, 25, 500, 17);
    private static final Item EYE_PATCH = new Item("Eye Patch", null, 25, 100, 18);
